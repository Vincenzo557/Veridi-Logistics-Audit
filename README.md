...
| Deliverable | Link |
|---|---|
| 📓 Notebook (Google Colab) | *(paste your Colab link here — set to "Anyone with link can view")* |
| 📊 Dashboard | *(paste your Streamlit Cloud / Looker Studio / Tableau Public link here)* |
| 🎨 Presentation (HTML) | *(upload `presentation.html` to GitHub Pages or host via any static host)* |
